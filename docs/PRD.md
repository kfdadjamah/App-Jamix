...
- Tant qu'une annonce est en statut Brouillon, l'organisateur peut librement ajouter ou retirer des dates. Une fois l'annonce Publiée, la liste des dates n'est plus modifiable depuis le formulaire de création ; sa modification (portée ciblée ou globale) relève du mécanisme de modification/annulation décrit ci-dessous.
